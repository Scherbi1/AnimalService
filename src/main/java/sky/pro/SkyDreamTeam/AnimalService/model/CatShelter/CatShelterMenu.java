...
public enum CatShelterMenu {
    START_C("Главное меню",
            Arrays.asList("START_C","INFO_C", "GET_PET_C", "REPORT_C", "CONNECTTOADMIN_C")),
    INFO_C("Информация",
            Arrays.asList("START_C", "SHELTERINFO_C", "CONTACT_C", "SECURITY_C","GET_CLIENTCONTACT_C","CONNECTTOADMIN_C")),
    ...
    GET_PET_C("Взять Кошку",
            Arrays.asList("START_C","GET_PET_RULES_C","GET_PET_DOCS_C","GET_PET_RECOM_C",
                    "GET_PET_REJECT_C","GET_CLIENTCONTACT_C","CONNECTTOADMIN_C")),
    GET_PET_RULES_C("Правила знакомства с кошкой",
            Arrays.asList()),
    GET_PET_DOCS_C("Список документов",
            Arrays.asList()),
    GET_PET_RECOM_C("Рекомендации",
            Arrays.asList("START_C","GET_PET_RECOM_TRANSPORT_C","GET_PET_RECOM_HOUSE_C",
